...
RUN rm -rf /build/x265/build/linux/8bit /build/x265/build/linux/10bit /build/x265/build/linux/12bit && mkdir -p /build/x265/build/linux/8bit /build/x265/build/linux/10bit /build/x265/build/linux/12bit
